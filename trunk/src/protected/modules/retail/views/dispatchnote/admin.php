...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
	...
	'columns' => array(
		...
		array(
			...
			'value' => function ($data) {return '<a rel="popover" title="Nota de envío Nº ' . $data->dispatch_note_number . '" data-content="' . $data->comment . '">' . $data->comment . '</a>';},
			'htmlOptions' => array(
				'title' => $model->comment,
			),
		),
		...
		array(
			...
			'filter' => CHtml::listData($model->getPending(), 'user.id', 'user.username'),
		),
		array(
...
<div id="modal-dispatch-note" class="modal hide fade" style="">
	...
	<div class="modal-footer">
	    <a href="#" id="cancel_dispatch" class="btn btn-warning"><?php echo Yii::t('app', 'Anular Nota de envío');?></a>
