...
<?php echo TbHtml::submitButton(Yii::t('app', 'Aprobar'), array('class' => 'checks-submit btn-primary', 'data-checkcolumn' => 'purchase_selected', 'data-submit-action' => Yii::app()->createUrl('/owner/purchase/setapproved')));?>
<!--<?php echo TbHtml::submitButton(Yii::t('app', 'Recotizar'), array('class' => 'checks-submit btn-info', 'data-checkcolumn' => 'purchase_selected'));?>-->
<?php echo TbHtml::submitButton(Yii::t('app', 'Rechazar'), array('class' => 'checks-submit btn-danger', 'data-checkcolumn' => 'purchase_selected', 'data-submit-action' => Yii::app()->createUrl('/owner/purchase/setrejected')));?>
...
<div id="modal-purchase" class="modal hide fade" style="">
	...
	<div class="modal-footer">
	    ...
	    <!--<a href="#" id="in-observation-purchase" class="btn btn-primary"><?php echo Yii::t('app', 'En observación');?></a>-->
	</div>
</div>
