...
<div>
    <?php echo $form->labelEx($dispatch_note, 'comment_received'); ?>
    <?php echo $form->textArea($dispatch_note, 'comment_received', array('class' => 'span12', 'style' => 'height:200px')); ?>
    <?php if ($dispatch_note->hasErrors('comment_received')) : ?>
        <div class="alert alert-block alert-error">
            <button type="button" class="close" data-dismiss="alert">&times;</button>
            <?php echo $form->error($dispatch_note, 'comment_received'); ?>
        </div>
        <?php endif;
    ?>
</div>
...
<div class="alert alert-success">
    ...
    <?php echo TbHtml::linkButton(Yii::t('app', 'Volver'), array('class' => 'btn btn-large pull-right', 'url' => array('/dispatchnote/list/expecting'))); ?>
</div>
</br>
</br>
</br>
